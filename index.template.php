...
function template_body_above()
{
	...
	<div id="topbar">
		<div class="wrapper">
			...
			<div id="sociallinks" class="floatright">
				<ul>
					<li>
						<a target="_blank" title="Facebook" href="https://www.facebook.com/"><i class="largetext fa fa-facebook"></i></a>
					</li>
					<li>
						<a target="_blank" title="Twitter" href="https://twitter.com/"><i class="largetext fa fa-twitter"></i></a>
					</li>
					<li>
						<a target="_blank" title="Youtube" href="https://www.youtube.com/"><i class="largetext fa fa-youtube"></i></a>
	...
	echo '
	<div id="top_section">
		<div id="header" class="wrapper', !empty($settings['header_layout']) ? ($settings['header_layout'] == 1 ? ' centerheader' : ' rightheader') : '', '">
...
function template_th_search_bar()
{
	...
	echo '
				<button type="submit" name="search;sa=results" value="', $txt['search'], '" class="search_button buttton_submit', (!empty($modSettings['search_dropdown'])) ? ' with_select' : '', '" >', $txt['search'], '</button>
